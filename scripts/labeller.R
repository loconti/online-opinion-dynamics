...
submissions_pred <- getPredictions(submissions, contentColumnNumber = 3)
...
comments_pred <- getPredictions(comments, contentColumnNumber = 3)
...
# Write to CSV
write.csv(submissions, "Data/diffusions_submissions_labeled.csv", row.names = FALSE)
